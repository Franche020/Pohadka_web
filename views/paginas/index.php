...
<main class="card card--hero">
    ...
    <section id="discover" class="card discover">
        ...
        <picture class="discover__imagen">
            <source srcset="build/img/fire.webp" type="image/webp">                
            <img src="build/img/fire.jpg" alt="Imagen de un vocalista del Festival">
        </picture>
        <a href="/about">
            <button class="boton">
                Discover
    ...
    <section id="accommodation" class="card live">
        <div class="live__texto">
            ...
            <p>Join us and discover a unique lifestyle!</p>
        </div>
        <picture class="live__imagen">
    ...
    <section id="events" class="card eventos">
        <div class="events__texto">
            ...
            <ul>
                ...
                <li>Workshops and spiritual growth</li>
                <li>Bar with billiards</li>
                <li>Jam music sessions</li>
              </ul>
        </div>
          <picture class="events__imagen">
            <source srcset="build/img/river2.webp" type="image/webp">                
            <img src="build/img/river2.jpg" alt="Imagen de un vocalista del Festival">
        </picture>
        <a href="/events">
            <button class="boton">
                Activities
